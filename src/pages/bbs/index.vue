        ...
        <swiper style="height: 100vh" :current="curr" @change="setCurr">
          <swiper-item>
            <scroll-view scroll-y class="sgscroll">
              <view class="sglist">
                <navigator @click="goDetail(item._id)" class="sglist-item" v-for="(item, index) in recommendlist"
                  :key="index">
          ...
          <swiper-item>
            <scroll-view scroll-y class="sgscroll">
              <view class="sglist">
                <navigator @click="goDetail(item._id)" class="sglist-item" v-for="(item, index) in nearlist"
                  :key="index">
                  <view class="sglist-view">
                    <view class="sglist-title">
                      {{ item.title }}
